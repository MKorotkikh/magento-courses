...
class Ainstainer_TechTalk_Block_Adminhtml_Contact_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    public function __construct()
    {
        ...
        $this->_addButton('saveandcontinue', array(
            'label'     => Mage::helper('techtalk')->__('Save and Continue Edit'),
    ...
    public function getHeaderText()
    {
        if (Mage::registry('contact_request')->getId()) {
            return Mage::helper('techtalk')->__("Edit Contact '%s'", $this->escapeHtml(Mage::registry('contact_request')->getName()));
        }
        else {
            return Mage::helper('techtalk')->__('New Contact');
        }
    }
